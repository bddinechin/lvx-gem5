...
c5:
	...
	floatwd $r3 = $r1
	;;
	maked $r4 = 0xc000000000000000ULL		# -2.0
	;;
	ccb.deq $r3, $r4 ? c6
	;;
	goto fail
...
c8:
	...
	maked $r0 = 8
	;;
	maked $r1 = 0x4022000000000000ULL		# 9.0
	;;
	fixedd $r3 = $r1
	;;
	maked $r4 = 9
...
c9:
	...
	maked $r0 = 9
	;;
	maked $r1 = 0x4024000000000000ULL		# 10.0
	;;
	fixedudw $r3 = $r1
	;;
	maked $r4 = 10
...
c11:
	...
	maked $r0 = 11
	;;
	maked $r1 = 0x3ff8000000000000ULL		# 1.5
	;;
	fnarrowdw $r3 = $r1
	;;
	maked $r4 = 0x3fc00000				# 1.5f
	;;
	ccb.weq $r3, $r4 ? c12
	;;
	goto fail
...
c13:
	...
	maked $r0 = 13
	;;
	maked $r1 = 0xbff0000000000000ULL		# -1.0
	;;
	fixedudw $r3 = $r1
	;;
	maked $r4 = 0

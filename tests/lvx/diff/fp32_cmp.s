...
main:
	...
	;;
	make $r2 = 0x40400000		# 3.0f
	;;
	faddw $r3 = $r1, $r2
	;;
	make $r4 = 0x40a00000		# 5.0f
	;;
	ccb.weq $r3, $r4 ? c2
	;;
	goto fail
...
c2:
	...
	make $r0 = 2
	;;
	make $r1 = 0x40400000		# 3.0f (rz)
	;;
	make $r2 = 0x40a00000		# 5.0f (ry)
	;;
	fsbfw $r3 = $r1, $r2
	;;
	make $r4 = 0x40000000		# 2.0f
	;;
	ccb.weq $r3, $r4 ? c3
	;;
	goto fail
...
c4:
	...
	make $r2 = 0x40400000		# 3.0f
	;;
	make $r3 = 0x3f800000		# 1.0f (accumulator)
	;;
	ffmaw $r3 = $r1, $r2
	;;
	make $r4 = 0x40e00000		# 7.0f
	;;
	ccb.weq $r3, $r4 ? c5
	;;
	goto fail
...
c6:
	...
	make $r0 = 6
	;;
	make $r1 = 0x40c00000		# 6.0f (rz)
	;;
	make $r2 = 0x40400000		# 3.0f (ry)
	;;
	fdivw $r3 = $r1, $r2
	;;
	make $r4 = 0x40000000		# 2.0f
...
c8:
	...
	make $r0 = 8
	;;
	make $r1 = 0x40300000		# 2.75f
	;;
	frintw $r3 = $r1
	;;
	make $r4 = 0x40400000		# 3.0f
	;;
	ccb.weq $r3, $r4 ? c9
	;;
	goto fail
...
c13:
	...
	make $r0 = 13
	;;
	make $r1 = 0x7fc00000		# qNaN f32
	;;
	make $r2 = 0x40400000		# 3.0f
	;;
	fminw $r3 = $r1, $r2
	;;
	make $r4 = 0x7fc00000		# canonical NaN
	;;
	ccb.weq $r3, $r4 ? c14
	;;
	goto fail
